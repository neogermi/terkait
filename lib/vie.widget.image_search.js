            ...
            services    : {
                ...
                'flickr' : {
                    ...
                    tail_url  : function (widget, service) {
                        ...
                        url += "&extras=url_o,geo,media,url_s,url_z&format=json&jsoncallback=?";
            ...
            ts_url : {
                "Thing" : {
                    'flickr' : function (entity, serviceId) {
                        var url = "";
                        if (entity.has("rdfs:label")) { //was entity.has("name") before. doesn't work with entity.has("name") since entity's 'name' attribute is stored as <<:name>>
                            var name = entity.get("rdfs:label"); //was entity.has("name") before. doesn't work with entity.get("name") since entity's 'name' attribute is stored as <<:name>>
