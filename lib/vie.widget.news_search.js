...
(function($, undefined) {
    $.widget('view.vieNewsSearch', {
        ...
        _create: function () {
			...
			if (v.types.get("NewsArticle").attributes.get("depicts") !== undefined) {
				v.types.get("NewsArticle").attributes.add("depicts", ["Thing"]);
				v.types.get("Thing").attributes.get("image").range.push("NewsArticle");
                            ...
                            if (data && data.responseStatus === 200) {
                                ...
                                for (var r = 0; r < rData.length; r++) {
                                    ...
                                    var obj = {
                                        ...
                                        image         : res.image,
										content       : res.content,
										titleNoFormatting : res.titleNoFormatting,
